...
- **Text and pictures** in your installed fonts through a TrueType reader and rasterizer written here, with **Sashfold Mono** as the honest last fallback; PNG, GIF and JPEG decoders, `srcset` and `<picture>`; CSS background images and gradients (layers, position, size, repeat, clip).
...
Not written yet: scripting, collapsing table borders, subgrid, rounded corners, WOFF fonts, windows and TLS on Linux and macOS, and more — the honest list is [Not written yet](https://github.com/codingncaffeine/Sashfold/wiki/Not-written-yet). What Sashfold cannot do, it does not do.
...
| WPT CSS reference tests, 13,477 tests over CSS2 and fifteen `css-*` directories | **6245 / 13477 (46.3%)** — the table is at [sashfold.com/wpt.html](https://sashfold.com/wpt.html) |
