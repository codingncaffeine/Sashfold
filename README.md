...
JPEG and GIF images, floats, flexbox, tables, and scripting are not written yet — and nothing stands in for them: what Sashfold cannot do, it does not do.
