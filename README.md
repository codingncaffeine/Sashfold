...
- **Styling** — CSS syntax, selectors, the cascade with `inherit`/`initial`/`unset`, custom properties, `calc()`, media queries, external stylesheets, `@font-face` (TrueType), generated content with counters, `::first-letter`, every named color.
...
| WPT CSS reference tests, 13,477 tests over CSS2 and fifteen `css-*` directories | **7474 / 13477 (55.5%)** — the table is at [sashfold.com/wpt.html](https://sashfold.com/wpt.html) |
