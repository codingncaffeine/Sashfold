...
| WPT testharness tests, 75,630 subtests over 1278 test files under seventeen `dom/` and `html/` directories | **67355 / 75630 (89.1%)** — the table is at [sashfold.com/wpt-harness.html](https://sashfold.com/wpt-harness.html) |
