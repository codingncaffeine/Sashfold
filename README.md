...
Animated GIF, sticky positioning under scroll, tables, grid, counters, web-font formats, and scripting are not written yet — and nothing stands in for them: what Sashfold cannot do, it does not do.
...
sashfold --render page.html -o out.png      # render a page headlessly (--report, --thumbnail, --max-height, --dump-layout)
