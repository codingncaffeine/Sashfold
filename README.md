...
- **Layout** — block and inline layout, margin collapsing, floats, flexbox, grid (tracks, `fr`, `repeat()`, areas, named lines, spans, alignment), positioning with stacking contexts, inline-block, `vertical-align`, replaced boxes, percentage heights.
...
Not written yet: scripting, tables (cells stand in as inline-blocks), subgrid, background images, WOFF fonts, windows and TLS on Linux and macOS, and more — the honest list is [Not written yet](https://github.com/codingncaffeine/Sashfold/wiki/Not-written-yet). What Sashfold cannot do, it does not do.
...
| WPT CSS reference tests, 13,477 tests over CSS2 and fifteen `css-*` directories | **5856 / 13477 (43.4%)** — the table is at [sashfold.com/wpt.html](https://sashfold.com/wpt.html) |
