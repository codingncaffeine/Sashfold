...
| WPT CSS reference tests, 14,616 tests over CSS2 and sixteen `css-*` directories | **9427 / 14616 (64.5%)** — the table is at [sashfold.com/wpt.html](https://sashfold.com/wpt.html) |
| WPT testharness tests, 74,294 subtests over 1260 test files under seventeen `dom/` and `html/` directories | **65627 / 74294 (88.3%)** — the table is at [sashfold.com/wpt-harness.html](https://sashfold.com/wpt-harness.html) |
