...
// Generated by tools/gen-keysyms.sh from X11/keysymdef.h (The Open Group,
// MIT/X11 licence). The X keysym encoding is the public vocabulary xkb
// keymaps name their symbols in; nothing here is code.
//
// keysym_names: every named keysym, sorted by name for binary search.
// keysym_code_points: keysyms that type a character but are not the
// character's own number (ASCII and Latin-1 keysyms are; the U+ form is),
// sorted by keysym.

#include <cstdint>

namespace sashfold::platform::xkb::data {
...
struct KeysymCodePoint {
    std::uint32_t keysym;
    char32_t code_point;
};

inline constexpr KeysymName keysym_names[] = {
    { "0", 0x0030 },
    { "1", 0x0031 },
    { "2", 0x0032 },
    { "3", 0x0033 },
...
inline constexpr KeysymCodePoint keysym_code_points[] = {
    { 0x01a1, 0x0104 },
    { 0x01a2, 0x02D8 },
    { 0x01a3, 0x0141 },
    { 0x01a5, 0x013D },
