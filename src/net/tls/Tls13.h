...
// byte (RFC 8448 §3 is the test). One cipher suite,
// TLS_CHACHA20_POLY1305_SHA256; one group, x25519; no resumption, no
// early data, no client certificates (an empty one answers a request).
