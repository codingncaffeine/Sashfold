...
// The static dictionary of brotli (RFC 7932 Appendix A): 122,784 bytes, the
// Appendix's hex as bytes, written out by `xxd -i -c 16`. The CRC-32 the
// RFC gives for them, 0x5136cb04, is checked by test_brotli.

#include <cstdint>

namespace sashfold {

inline constexpr std::uint8_t brotli_dictionary[122784] = {
